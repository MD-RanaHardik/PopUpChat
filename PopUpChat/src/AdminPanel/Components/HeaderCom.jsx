        ...
        <div className="bg-white shadow-lg py-5 w-full grid grid-cols-6">
            ...
            <div className="col-span-5 flex px-2 justify-between">
                <div>
                    ...
                    {
                        (admindata.property != undefined) && admindata.property[property_id]["Widget"]["Widget_name"]
                    }
                    </h2>
                </div>
                <div className="flex">          
                    ...
                    <NavLink to={`/`}><button data-toggle="tooltip" data-placement="bottom" title="Logout"  className=" h-8 w-8 mx-3 rounded-full hover:ring-1 hover:ring-blue-950 hover:rounded-sm"> <img  src="https://img.icons8.com/sf-regular/48/172554/exit.png" alt="home"/></button></NavLink>
