          ...
          ">
            ...
            <div style="background-color: rgb(219 234 254) !important; padding: 4% !important">
                <button id="chatnowbtn" onclick="ChatNowBtn()" class="poppins"
                    style=" flex-shrink: 0 !important; background-color: ${color} !important; color: white !important;  width: 100% !important; padding: 10px 0px 10px 0px !important; font-size: 1rem !important; border-radius: 13px !important; border: none !important;">Chat
                    now</button>
